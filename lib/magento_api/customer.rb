module MagentoAPI
  ...
  class Customer < Base
    class << self
      ...
      # MagentoAPI stored the value. If you try to match with an unsalted MD5 hash, or any salt other 
      # than what MagentoAPI used, it will not match. This is just a straight string comparison.
      def list(*args)
